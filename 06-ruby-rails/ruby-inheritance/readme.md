...
* Install `byebug` using `gem`. byebug is an improved REPL for Ruby that allows for better debugging and lets you work interactively with pre-written scripts through the use of `byebug`
...
Create a few rectangles and a square at the end of your file. Write `byebug` to stop the program after the shapes
are created.
